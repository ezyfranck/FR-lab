...
namespace ConsoleApp3.ezyapi.Partner.mapper
{
    ...
    public static class CustomerMapper
    {
        ...
        public static OdooDictionaryModel ToDbModel(Customer customer, ResPartnerOdooModel? existingInstance = null)
        {
            return OdooDictionaryModel.Create(() => new ResPartnerOdooModel()
            {

                Name = customer.RecipientName,
                Street = customer.RecipientAddress1,
                Street2 = customer.RecipientAddress2,
                Zip = customer.RecipientPostalCode,
                City = customer.RecipientCity,
                Phone = customer.RecipientPhone,
                Mobile = customer.RecipientPhone2
        ...
        public static Customer ToApiModel(ResPartnerOdooModel partner)
        {
            return new Customer
            {
                ...
                RecipientPhone2 = partner.Mobile
            };
