...
namespace ConsoleApp3.ezyapi.Partner.mapper
{

    public static class PartnerMapper
    {

        public static ResPartnerOdooModel ToDbModel(Customer partner, ResPartnerOdooModel? existingInstance = null)
        {
            var instance = existingInstance ?? new ResPartnerOdooModel();

            if (partner.Id != "NULL_STRING")
            {
                instance.Id = long.Parse(partner.Id);
            }

            instance.Name = partner.RecipientName;
            instance.Street = partner.RecipientAddress1;
            instance.Street2 = partner.RecipientAddress2;
            instance.Zip = partner.RecipientPostalCode;
            instance.City = partner.RecipientCity;
            instance.Phone = partner.RecipientPhone;
        ...
        public static Customer ToApiModel(ResPartnerOdooModel partner)
        {
            return new Customer
            {
            ...
            //Id = string.Parse(article.Id);
                ...
                RecipientAddress1 = partner.Street,
                RecipientAddress2 = partner.Street2,
                RecipientPostalCode = partner.Zip,
